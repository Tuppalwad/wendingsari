        ...
        <nav class="container navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        <i class="fa fa-cart-shopping me-2 mt-2"></i>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss1.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Party Wear
                        </h5>
                        <p class="card-text">Price 4530 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss2.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Wending
                        </h5>
                        <p class="card-text">Price 3560 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss3.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Reception
                        </h5>
                        <p class="card-text">Price 2430 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss4.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Classic
                        </h5>
                        <p class="card-text">Price 3450 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss5.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Casual
                        </h5>
                        <p class="card-text">Price 2330 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card" style="width: 18rem">
                    <img src="Assets/ss6.jpg" class="card-img-top" alt="..." />
                    <div class="card-body text-center">
                        <h5 class="card-title">
                            Traditional
                        </h5>
                        <p class="card-text">Price 1330 Rs</p>
                        <a href="/wendingsari/Cart.php" class="btn btn-primary">Add To card</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-inline">
                        <li class="list-inline-item" style="list-style: none;"><a href="#" class="text-white"
